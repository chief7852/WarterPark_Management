...
<!-- <!-- 	<label class="btn btn-primary SE" id="pos-start" for="btn-check">개시</label> -->
<!-- <!-- 	<label class="btn btn-primary SE" id="pos-end" for="btn-check">마감</label> -->
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        <a id='deadlined' class="nav-link" data-bs-toggle="modal" role="button" href="#" >
          <i class="bi bi-calendar2-check SE" id="pos-start"></i>
        </a>
     ...
     <li class="nav-item dropdown">
        <a id="alams" class="nav-link" data-toggle="dropdown" href="#" aria-expanded="false">
